...
$if[$eventData[[0]]==loading_site_info_fetch]
 ...
 $channelSendMessage[1425016587660038257;-# **$eventData[[4]]** [<t:$round[$divide[$eventData[[4]];1000]]> (<t:$round[$divide[$eventData[[4]];1000]]:R>)\] \` $eventData[[6]] \` : <$replaceText[$replaceText[$replaceText[$eventData[5];/newline**💻;];Registered From: **;]; ;]>;false]
...
-# 🖥️ **• Reverse DNS:** \` ${apiinfo.reverse} \` `,
  ...
  image: { url: mapURL }
    ...
    event.emit('message', "loading_site_info_fetch", "req.query.guild", "req.query.avatar_url", "req.query.username", sessionid, name, ip, "req.query.details");
